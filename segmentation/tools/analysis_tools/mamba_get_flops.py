...
def mmengine_flop_count(model: nn.Module = None, input_shape=(3, 224, 224), show_table=False, show_arch=False,
    ...
    def get_model_complexity_info(
        ...
        if model.backbone.__class__.__name__ == 'MM_LocalVim':
            supported_extra_ops_["prim::PythonOp.MambaInnerFnNoOutProj"] = partial(MambaInnerFnNoOutProj_flop_jit,
...
def mmdet_flops(config=None):
    ...
    if True:
        ...
        for idx, data_batch in enumerate(data_loader):
            ...
            out = get_model_complexity_info(model, input_shape=(3, 2048, 512))
